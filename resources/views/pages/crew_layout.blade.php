...
<title>Main layout page </title>
  ...
  <!-- Form CSS -->
    ...
    <!-- Icons font CSS-->
    <link href="eventReg/vendor/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">
    <link href="eventReg/vendor/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
    <!-- Font special for pages-->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i" rel="stylesheet">

    <!-- Vendor CSS-->
    <link href="eventReg/vendor/select2/select2.min.css" rel="stylesheet" media="all">
    <link href="eventReg/vendor/datepicker/daterangepicker.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="eventReg/css/main.css" rel="stylesheet" media="all">
</head>
<body>
<div class="main-panel">
      ...
      <div class="logo"><a href="{{ route('home') }}" class="simple-text logo-normal">
        ...
        <div class="sidebar-wrapper">
          <ul class="nav">
            ...
            <li class="nav-item ">
              <a class="nav-link" href="{{ route('crew_list') }}">
 ...
 <script src="admin/js/core/jquery.min.js"></script>
  ...
  <script>
    ...
    <!-- Jquery JS-->
    <script src="eventReg/vendor/jquery/jquery.min.js"></script>
    <!-- Vendor JS-->
    <script src="eventReg/vendor/select2/select2.min.js"></script>
    <script src="eventReg/vendor/datepicker/moment.min.js"></script>
    <script src="eventReg/vendor/datepicker/daterangepicker.js"></script>

    <!-- Main JS-->
    <script src="eventReg/js/global.js"></script>
</body>
</html>