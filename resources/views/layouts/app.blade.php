...
<!-- Required meta tags-->
    ...
    <!-- Icons font CSS-->
    <link href="registerPage/vendor/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">
    <link href="registerPage/vendor/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
    <!-- Font special for pages-->
    <link href="https://fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

    <!-- Vendor CSS-->
    <link href="registerPage/vendor/select2/select2.min.css" rel="stylesheet" media="all">
    <link href="registerPage/vendor/datepicker/daterangepicker.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="registerPage/css/main.css" rel="stylesheet" media="all">
</head>
<body>
    <div id="app">
